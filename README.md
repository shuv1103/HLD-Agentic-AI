# DesignMind — Agentic HLD Generator

DesignMind turns a Product Requirements Document (a PRD PDF) into a complete High-Level Design: structured markdown and HTML, Mermaid class and sequence diagrams rendered to images, a risk heatmap, and a quality score for the generated design. It's built as a six-stage agent pipeline on **LangGraph**, with **Google Gemini** doing the reasoning and a small **scikit-learn / XGBoost** layer for scoring HLD quality.
